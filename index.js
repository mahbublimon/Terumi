...
// Import and initialize musicPlayer
const { searchSpotifyTrack, playSpotifyTrack } = require('./src/utils/musicPlayer');
...
const client = new Client({
  intents: [
    ...
    GatewayIntentBits.MessageContent, // To receive message content if needed
  ],
});

client.commands = new Collection(); // Store bot commands
